...
GITHUB_RELEASE_JSON=$(curl --silent "https://api.github.com/repos/hermit28/CCminer-ARM-optimized/releases?per_page=1" | jq -c '[.[] | del (.body)]')
...
wget https://raw.githubusercontent.com/hermit28/Android-Mining/main/config.json -P ~/ccminer
